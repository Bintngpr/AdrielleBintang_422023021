function getDataByWindowUrlKey(){
    ...
    let url = baseUrl+'/api/figure/'+windowUrlKey;
    ...
    .then(function(response) {
      ...
      $('#product-series').html(response.data.series);
      $('#product-publisher').html('First published' + response.data.release_year+'by'+response.data.publisher);
      ...
      // START -- note, unless you have these data in a database structure, here we are hardcoding them for display purposes
        ...
        // tag
        let collectionOfTag = ['Figure', 'Ebook', 'Best Seller', 'Fiction', 'Education', 'Literature', 'Classics','Real Event', 'Young Adult', 'Religion', 'Health', 'Comic', 'Horror', 'Poem', 'Filmed', 'Encyclopedia', 'In English', 'In Indonesian'];
