...
class FigureController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data['products']     = Figure::whereRaw('1 = 1');
        ...
        switch ($request->get('_sort_by')) {
            default:
            case 'latest_release':
            $data['products'] = $data['products']->orderBy('release_year','DESC');
            break;
            case 'latest_added':
     ...
     *             example={"title": "Hinata", "series": "Haikyuu", "publisher": "Orange Rouge", "release_year": "2017", "category": "figma", 
